...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-col justify-between bg-[#0A5C3A] w-[45%] p-12 overflow-hidden relative">
        ...
        <div className="z-10 mt-16 mb-auto space-y-8">
          ...
          <div className="flex flex-col items-start gap-3">
            {[
              { icon: '≡ƒÆ¼', text: 'Instant WhatsApp lead alerts' },
              { icon: '≡ƒôè', text: 'Track every lead to close' },
              { icon: 'Γ¡É', text: 'Reviews that win customers' },
            ].map((feature, i) => (
              <div 
                key={i}
      ...
      {/* ΓöÇΓöÇ RIGHT: Login form ΓöÇΓöÇ */}
      <div className="flex-1 flex items-center justify-center bg-white p-12">
        ...
        <div className="w-full max-w-sm">
          ...
          {/* ΓöÇΓöÇ LOGIN METHOD TABS ΓöÇΓöÇ */}
          ...
          {/* ΓöÇΓöÇ EMAIL/PASSWORD FORM ΓöÇΓöÇ */}
          {loginMethod === 'email' && (
            <div className="space-y-[18px]">
              ...
              {emailError && (
                <div className={`border rounded-[8px] px-3 py-2.5 text-[14px] flex items-start gap-2 ${emailError.includes('Γ£ô') ? 'bg-[#F0FDF4] border-[#BBF7D0] text-[#166534]' : 'bg-[#FEF2F2] border-[#FCA5A5] text-[#B91C1C]'}`}>
                  {!emailError.includes('Γ£ô') && <AlertTriangle className="w-[18px] h-[18px] text-[#EF4444] shrink-0 mt-[2px]" />}
          ...
          {/* ΓöÇΓöÇ WHATSAPP OTP FORM ΓöÇΓöÇ */}
